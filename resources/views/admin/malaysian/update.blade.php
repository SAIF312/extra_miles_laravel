                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <h3>Update Malaysian Fuel Price</h3>
                                @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <form method="post" action="{{route('malaysian.update')}}">
                                @csrf
                                <div class="form-group">
                                    <label for="title">Fuel title</label>
                                    <input type="text" class="form-control" value="{{$malaysian->title}}" id="title" placeholder="Enter grade" disabled>
                                    <input value="{{$malaysian->id}}" name="id" hidden>
                                    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                </div>
                                <div class="form-group">
                                    <label for="grade">Fuel Price</label>
                                    <input type="number" step="0.01" class="form-control" value="{{$malaysian->price}}" id="price" name="price" placeholder="Enter grade">
                                    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                </div>
